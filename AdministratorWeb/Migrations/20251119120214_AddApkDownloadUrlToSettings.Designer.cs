...
namespace AdministratorWeb.Migrations
{
    ...
    [Migration("20251119120214_AddApkDownloadUrlToSettings")]
    partial class AddApkDownloadUrlToSettings
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AdministratorWeb.Models.AccountingActionLog", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("AdministratorWeb.Models.EmailPreferences", b =>
                {
                    ...
                    b.Property<bool>("RequestStatusNotifications")
                        .HasColumnType("tinyint(1)");
            ...
            modelBuilder.Entity("AdministratorWeb.Models.ProfileUpdateLog", b =>
                {
                    ...
                    b.Property<bool>("ProfilePictureChanged")
                        .HasColumnType("tinyint(1)");
            ...
            modelBuilder.Entity("AdministratorWeb.Models.RequestActionLog", b =>
                {
                    ...
                    b.HasIndex("CustomerId", "ActionedAt");
            ...
            modelBuilder.Entity("AdministratorWeb.Models.EmailLog", b =>
                {
                    b.HasOne("AdministratorWeb.Models.ApplicationUser", "User")
                        .WithMany()
